...
export function WeekInfo({
  ...
  return (
    <div className="grid grid-cols-[auto_1fr] gap-x-12 gap-y-5 sm:gap-x-16 sm:gap-y-6 items-start">
      ...
      {/* Status */}
      <div className="text-[0.75rem] sm:text-[0.85rem] font-satoshi text-muted-foreground flex items-center h-[1.1rem] sm:h-auto sm:items-baseline">
        Status
      </div>
        ...
        <>
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            {resources.map((res, i) => (
              <div
                key={i}
                className="text-[0.75rem] sm:text-[0.85rem] font-satoshi"
              >
