    ...
    <>
      ...
      >
        ...
        <p className={getParagraphClass({ responsive: true, muted: false })}>
          ...
          , the{" "}
          <code className={getInlineCodeClass()}>RandomForestClassifier</code>{" "}
          dominates both accuracy and the Brier Score measure, indicating that
          it correctly predicts more positive instances than the{" "}
        ...
        <p className={getParagraphClass({ responsive: true, muted: false })}>
          ...
          as bar plots. The correctness (accuracy in this case) refers to binary
          accuracy per prediction and it is <InlineMath math="1" /> if the
          predicted class is correct, that is if{" "}
